...
# ウィジェットUI定義
# ========================
name_input = widgets.Text(description='氏名：', layout=widgets.Layout(width='300px'))
output_label = widgets.Label(value="")

in_button = widgets.Button(description='出勤', button_style='danger', layout=widgets.Layout(width='150px'))
out_button = widgets.Button(description='退勤', button_style='info', layout=widgets.Layout(width='150px'))
download_button = widgets.Button(description='Excelをダウンロード', layout=widgets.Layout(width='300px'))
...
# 中央揃えレイアウト表示
# ========================
button_row = widgets.HBox([in_button, out_button], layout=widgets.Layout(justify_content='center', gap='20px'))
main_ui = widgets.VBox(
    [name_input, button_row, output_label, download_button],
